...
<body class="index-page sidebar-collapse">
      ...
      <div class="section section-dark">
          <div class="container">
            <div class="row">
              <div class="col-md-8 ml-auto mr-auto text-center">
                ...
                <p class="description">Thank you for being a trainee of Sport and Fitness Centre.</p>
        ...
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto text-center">
            <form class="contact-form" action="{{ route('trainee_profile') }}" method="post">
              ...
              <br>
              <a href="showtraineeprofile" class="description"><b><u>Show Previous Profile</u></b></a><br><br>
              <p class="description"><b><i>**Please update your profile every month for coach to know your progress**</i></b></a>
            </form>
