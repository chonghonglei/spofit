...
<body class="index-page sidebar-collapse">
      <nav class="navbar navbar-expand-lg fixed-top navbar-transparent" color-on-scroll="300">
        <div class="container">
          ...
          <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" rel="tooltip" title="Facilities" data-placement="bottom" href="/login_facilities_schedule" target="_blank">
                  <u>Facilities</u>
                </a>
              </li>
              <li class="nav-item">
    ...
    <div class="container">
        <div class="row">
                <h4 class="title">Facilities Booking Schedule</h4>
                <hr>
                <table class="table">
