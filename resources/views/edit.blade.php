      ...
      <div class="section section-dark">
        ...
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto text-center">
            <form class="contact-form" action="{{ route('update_facilities') }}" method="post">
                    ...
                    <img id="uploadPreview" value="{{ $data['id'] }}">
              ...
              <div class="row">
                ...
                <label class="description">Facilities Description</label>
                  <div class="input-group">
                    <textarea class="form-control" rows="4" id="description" name="description" placeholder="Description">{{ $data['description'] }}</textarea>
                  </div>
                </div>
              </div>
