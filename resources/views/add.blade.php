      ...
      <div class="section section-dark">
        ...
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto text-center">
            <form class="contact-form" action="{{ route('add_facilitiesID') }}" method="post">
              ...
              <div class="row">
                <div class="col-md-8 ml-auto mr-auto text-center"><br><br>
                  <label class="description">Facilities ID</label>
                  <div class="input-group">
                    <input type="text" class="form-control" id="no" name="no" placeholder="ID" value="{{ old('no') }}">
                  </div>
                </div>
              </div>
              ...
              <a href="../facilitiesID" class="description"><b><u>Display Facilities ID</u></b></a><br><br>
            </form>
